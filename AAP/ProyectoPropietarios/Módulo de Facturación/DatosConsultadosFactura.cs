...
{
    public partial class DatosConsultadosFactura : Form
    {
        public DatosConsultadosFactura()
        {
            InitializeComponent();
            this.CenterToScreen();
        }

        private void DatosConsultadosFactura_Load(object sender, EventArgs e)
        {
            lectura();
        }
        ...
        {
            ConsultarFactura consultarFac = new ConsultarFactura();
            consultarFac.Show();
            this.Hide();
        }
    }
