...
using ProyectoPropietarios.Módulo_de_Administración.Parámetros;
...
namespace ProyectoPropietarios
{
    ...
    public partial class MenuPrincipal : Form
    {
        ...
        public string[] conexstring = new string[4];
        ...
        {
            actualizarIVA act = new actualizarIVA();
            act.Show();
            this.Hide();
        ...
        {
            ActualizarUsuarios actualizarcont = new ActualizarUsuarios();
            actualizarcont.Show();
            this.Hide();
